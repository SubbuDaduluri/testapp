...
To build the final jar and optimize the SPMicro application for production, run:
...
Then navigate to [http://localhost:2017](http://localhost:2017) in your browser.
