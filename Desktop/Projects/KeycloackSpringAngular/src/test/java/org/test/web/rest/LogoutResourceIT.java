...
import org.test.KeycloackSpringAngularApp;
...
import static org.test.web.rest.TestUtil.ID_TOKEN;
import static org.test.web.rest.TestUtil.authenticationToken;
 ...
 */
@SpringBootTest(classes = {KeycloackSpringAngularApp.class, TestSecurityConfiguration.class})
