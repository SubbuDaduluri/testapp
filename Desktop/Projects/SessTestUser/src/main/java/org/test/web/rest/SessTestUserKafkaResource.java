...
@RestController
@RequestMapping("/api/sess-test-user-kafka")
public class SessTestUserKafkaResource {

    private final Logger log = LoggerFactory.getLogger(SessTestUserKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public SessTestUserKafkaResource(KafkaProperties kafkaProperties) {
