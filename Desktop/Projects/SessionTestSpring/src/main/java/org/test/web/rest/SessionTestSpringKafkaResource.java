...
@RestController
@RequestMapping("/api/session-test-spring-kafka")
public class SessionTestSpringKafkaResource {

    private final Logger log = LoggerFactory.getLogger(SessionTestSpringKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public SessionTestSpringKafkaResource(KafkaProperties kafkaProperties) {
